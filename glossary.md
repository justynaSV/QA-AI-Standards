...
| **Specialized standards repo** | A repository maintaining craft-specific standards (e.g. `postman-testing`, `gherkin-scenarios-tmp`) that this hub links to instead of duplicating. |
